// Script para interatividade da página de produto de cachorro
...
function initializeElements() {
    console.log('Inicializando elementos da interface para produtos de cachorro...');
    ...
    if (addToCartBtn) {
        addToCartBtn.addEventListener('click', function() {
            ...
            setTimeout(() => {
                ...
                showNotification(`${quantity} unidade(s) do Osso Dental adicionada(s) ao carrinho!`, 'success');
            }, 1500);
        });
    }
